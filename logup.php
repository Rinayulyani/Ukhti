	...
	<div id="wrapper">
		<div class="out-logup">
			<div class="out-logup1">
				<div id="daftar-logup">
					<div class="cinta">Nama Depan</div>
					<div class="cinta">Nama Belakang</div>
				...
				<div id="kolom-logup">
					<form>
						<input type="text" name="fnama" placeholder="Nama Depan" class="nama-logup"></input>
						<input type="text" name="lnama" placeholder="Nama Belakang" class="nama-logup"></input>
						...
						<input type="text" name="jk" placeholder="Jenis Kelamin" class="nama-logup1"></input>
